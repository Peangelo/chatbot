<template>
  <div class="row">
    <div class="col-md-6">
      <div class="login-form" style="margin-left:580px">
        <div class="avatar" v-if="!activeLoading">
          <img src="@/assets/img/chat-logo.png" style="width:300px;margin-left:-100px;margin-top:-70px;" alt="Avatar">
        </div>
    ...
    <div class="banner col-md-6">
      <img class="img-lateral"  alt="" srcset="">
    </div>
  </div>
</template>
